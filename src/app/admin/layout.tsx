    ...
    <div className={styles.page}>
      ...
      >
        ...
        <nav className={styles.nav}>
          ...
          <Link
            href="/admin/police"
            className={`${styles.navLink} ${isActive("/admin/police") ? styles.active : ""}`}
            onClick={() => setMobileMenuOpen(false)}
          >
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
          ...
          <Link
            ...
            className={`${styles.navLink} ${isActive("/admin/incidents") ? styles.active : ""}`}
            onClick={() => setMobileMenuOpen(false)}
          >
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
          ...
          <Link
            href="/admin/areas"
            className={`${styles.navLink} ${isActive("/admin/areas") ? styles.active : ""}`}
            onClick={() => setMobileMenuOpen(false)}
          >
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
          ...
          <Link
            href="/admin/audit"
            className={`${styles.navLink} ${isActive("/admin/audit") ? styles.active : ""}`}
            onClick={() => setMobileMenuOpen(false)}
          >
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
