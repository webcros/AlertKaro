...
export default function ReportPage() {
    ...
    useEffect(() => {
        ...
        if (!locationMapInstanceRef.current) {
            ...
            // Update map view
            locationMapInstanceRef.current.setView([location.latitude, location.longitude], 16);
        }
        ...
        if (ctx) {
            ...
            canvas.toBlob((blob) => {
                if (blob) {
                    ...
                    setMediaPreviews(prev => [...prev, canvas.toDataURL('image/jpeg')]);
                    stopCamera();
                    setStep('details');
                }
            }, 'image/jpeg', 0.8);
                    ...
                    <div className={styles.detailsStep}>
                        ...
                        <div className={styles.formSection}>
                            <label className={styles.sectionLabel}>
                                Location
                                <span className={styles.sectionHint}>(Required for accurate incident tracking)</span>
                            </label>
                                ...
                                {locationLoading ? (
                                    ...
                                    <>
                                        ...
                                        <div className={styles.locationMapContainer}>
                                            <div ref={locationMapRef} className={styles.locationMap}></div>
                                        ...
                                        <button onClick={getLocation} className={styles.refreshLocationButton}>
                                            <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
                                    ...
                                    <button onClick={getLocation} className={styles.getLocationButton}>
                                        <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
