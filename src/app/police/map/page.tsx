...
export default function PoliceMapPage() {
  ...
  const filteredIncidents = incidents.filter((incident) => {
    ...
    const matchesPriority =
      !showHighPriorityOnly || ["urgent", "high"].includes(incident.priority);
              ...
              <div className={styles.statusFilters}>
                {[
                  ...
                  <button
                    ...
                    style={
                      { "--chip-color": status.color } as React.CSSProperties
                    }
                  >
      ...
      {selectedIncident && (
        <div className={styles.incidentPanel}>
          ...
          <div className={styles.panelHeader}>
            <span className={styles.panelTrackingId}>
              #{selectedIncident.tracking_id}
            </span>
          ...
          <div className={styles.panelActions}>
            ...
            <button className={styles.panelButtonSecondary}>Assign</button>
          </div>
        </div>
      )}
    </>
