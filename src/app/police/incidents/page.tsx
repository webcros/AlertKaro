...
export default function PoliceAllIncidentsPage() {
  ...
  const filteredIncidents = incidents
    .filter((inc) => {
      ...
      // Status filter
      const matchesStatus =
        statusFilter.length === 0 || statusFilter.includes(inc.status);

      // Category filter
      const matchesCategory =
        categoryFilter.length === 0 ||
        categoryFilter.includes(inc.category?.name);
            ...
            <tr>
              <th className={styles.checkboxCell}>
                <input
                  type="checkbox"
                  checked={
                    selectedIds.size === filteredIncidents.length &&
              ...
              filteredIncidents.map((incident) => {
                ...
                return (
                  <tr
                    key={incident.id}
                    className={
                      selectedIds.has(incident.id) ? styles.selectedRow : ""
                    }
                  >
                    ...
                    <td className={styles.trackingId}>
                    ...
                    <td className={styles.reporterCell}>
