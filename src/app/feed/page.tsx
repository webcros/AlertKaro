                ...
                {loading ? (
                    ...
                    <div className={styles.feedList}>
                        {incidents.map((incident) => {
                            ...
                            return (
                                <article key={incident.id} className={styles.feedCard}>
                                    {/* Card Header */}
                                    ...
                                    {(citizenMedia || resolution) && (
                                        <div className={styles.mediaSection}>
                                            <div className={isResolved ? styles.mediaComparison : styles.mediaSingle}>
                                                {/* Citizen Media */}
                                                {citizenMedia && (
                                                    <div className={styles.mediaBlock}>
                                                        <span className={`${styles.mediaLabel} ${styles.citizenLabel}`}>
                                                ...
                                                {isResolved && resolution && (
                                                    <div className={styles.mediaBlock}>
                                                        <span className={`${styles.mediaLabel} ${styles.policeLabel}`}>
                                                            <svg viewBox="0 0 24 24" fill="currentColor" width="12" height="12">
                                                                <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z" />
                                                            </svg>
                                                            Resolved by Police
